...
Expression.prototype.evaluate = function() {
  ...
  switch (this.op) {
    ...
    case 'parameter':
      console.log("TODO: implement parameter evaluate")
    break;
    ...
    case '/':
      return Expression.numDiv(e0.eval(), e1.eval());
    ...
    case 'sqrt':
      return Math.sqrt(e0.eval());

    case 'sin':
      return Math.sin(e0.eval());

    case 'cos':
      return Math.cos(e0.eval());

    default:
      console.log('Unhandled op:', op, (new Error()).stack);
  }
};
